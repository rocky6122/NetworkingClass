...
struct GameMessageData
{
	...
	//We want a raw data array like this:
	char str[63]; //Raw data allows for 63 letters plus null terminator

	// ****TO-DO: implement game message data struct
	//std::string str;  Indirect use of a pointer

	//char *str; direct use of a pointer
};
			...
			)
		{
			...
			case ID_GAME_MESSAGE_1:
				...
				//	printf("%s\n", rs.C_String());
					...
					const GameMessageData *MSG = (GameMessageData *)packet->data;
